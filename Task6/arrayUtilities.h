...
*
*	The data in the fie is represented by a timestamp paired with a value. 
...
*		
*	The use of the following functions are recoommended:
...
* @param colSize is an one dimensional array that indicates the amount 
